...
public class TextAnalyzer
{
	...
	// Overloaded method to process text files
	public static String analyzeText(String input, String format) throws IOException
	{
		int counter = 0;
		...
		{
			System.out.println("Incorrect input format type, enter input followed by" +
			" format of file. Example: text.txt txt");
	...
	public static String analyzeText(String web) throws IOException
	{
		...
		try (BufferedReader br = new BufferedReader(new InputStreamReader(webtext.openStream())))
		{
			...
			// Limit amount of words to print
			int wordLimit = 20;
