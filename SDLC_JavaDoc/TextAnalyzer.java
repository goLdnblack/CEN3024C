...
* 
* Adding new notes using JavaDocs formatting
...
public class TextAnalyzer
{
	...
	* @param w Receives a hashmap to return a new hashmap in descending order
	*/
	...
	/**
	 * This function cleans the text read from the website by
	 * removing any special characters found.
	 * @param sb Contains the word without any special characters
	 * @param text May contain special characters
	 */
	...
	/**
	 * Removes specific instances of the mdash character and calls
	 * replaceSpecialChar for any specific characters to remove
	 * and add to the hashmap
	 * @param wordFreq Adds words without any special character to the hashmap
	 * @param sb Used to get rid of special characters for words
	 * @param text Original text containing special characters
	 */
	...
	/**
	 * Analyzes the text of a given website. The variables readInit and
	 * readEnd are used to point in the website the section containing
	 * the text to read and analyze.
	 * @param args Contains the website name with the text to analyze
	 * @throws IOException When bufferedreader is unable to read a valid website
	 */
